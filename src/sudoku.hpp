...
//Backend logic and structure of a sudoku board, with appropriate methods to fill and remove from the board
class Board {
public:
    //Default constructor, on its own, it fills the board with 0s
    Board();
    ...
    */
    ...
    /** Verifies whether a particular number is valid in a select row and column
    ...
    */
    ...
    //prints a visualisation of the sudoku board on the console (NOT USED)
    void printBoard();
    ...
    */
    ...
    //Sets all the cells to 0, then refills the board
    void reset();
